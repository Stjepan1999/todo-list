...
function showProjects() {
  ...
  for (let i = 0; i < storedProjects.length; i++) {
    ...
    editContainer.addEventListener('click', () =>
      (0,_editingProject__WEBPACK_IMPORTED_MODULE_1__.showEditOptions)(editContainer),
    );
  }
}
