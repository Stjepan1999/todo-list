/** *** */ (() => {
              ...
              (_ref6 =
                ...
                : (_defaultOptions$local3 = defaultOptions.locale) === null ||
                  ...
                  : (_defaultOptions$local4 =
                        _defaultOptions$local3.options) === null ||
  ...
  \************************************************** */
      /***/ (
        ...
        /* harmony import */ const _babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! @babel/runtime/helpers/esm/typeof */ './node_modules/@babel/runtime/helpers/esm/typeof.js',
          );
        /* harmony import */ const _lib_requiredArgs_index_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../_lib/requiredArgs/index.js */ './node_modules/date-fns/esm/_lib/requiredArgs/index.js',
          );
        ...
        function isDate(value) {
          (0, _lib_requiredArgs_index_js__WEBPACK_IMPORTED_MODULE_1__.default)(
            1,
            arguments,
          );
          return (
  ...
  \******************************* */
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ addEventListeners: () =>
            /* binding */ addEventListeners,
        ...
        /* harmony import */ const _creatingTask__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./creatingTask */ './src/creatingTask.js');
        /* harmony import */ const _editingProject__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./editingProject */ './src/editingProject.js',
          );
        ...
        function saveToLocalStorage() {
          ...
          localStorage.setItem(
            'taskID',
            _creatingTask__WEBPACK_IMPORTED_MODULE_0__.taskID.toString(),
          );
        }
        ...
        function createProjectElement(project) {
          ...
          editContainer.addEventListener('click', () =>
            (0, _editingProject__WEBPACK_IMPORTED_MODULE_1__.showEditOptions)(
              projectDiv,
            ),
          );
          ...
          // Create three dots
          const editIcons = (0,
          _creatingTask__WEBPACK_IMPORTED_MODULE_0__.createEditIcons)();
          ...
          deleteProjectButton.addEventListener('click', () =>
            (0, _editingProject__WEBPACK_IMPORTED_MODULE_1__.deleteProject)(
              project.id,
            ),
          );
          ...
          renameProjectButton.addEventListener('click', () =>
            (0, _editingProject__WEBPACK_IMPORTED_MODULE_1__.showRenameForm)(),
          );
        ...
        function selectProject(event, project) {
          ...
          (0, _creatingTask__WEBPACK_IMPORTED_MODULE_0__.showTasks)(
            project.tasks,
          );

          // Show form button for adding new tasks only in projects
          const showTaskFormButton = document.querySelector(
            '.create-task-button',
          );
  ...
  \**************************** */
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ createEditIcons: () =>
            /* binding */ createEditIcons,
          /* harmony export */ createTaskEvents: () =>
            /* binding */ createTaskEvents,
          /* harmony export */ findSelectedProject: () =>
            /* binding */ findSelectedProject,
          /* harmony export */ showTasks: () => /* binding */ showTasks,
          /* harmony export */ taskID: () => /* binding */ taskID,
          /* harmony export */
        });
        /* harmony import */ const _creatingProject__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./creatingProject */ './src/creatingProject.js',
          );
        /* harmony import */ const _editingTask__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./editingTask */ './src/editingTask.js');
        ...
        function createNewTask() {
          ...
          const project =
            _creatingProject__WEBPACK_IMPORTED_MODULE_0__.allProjects[index]
              .tasks;
          project.push(newTask);

          (0,
          _creatingProject__WEBPACK_IMPORTED_MODULE_0__.saveToLocalStorage)();
          closeForm();
          showTasks(project);
        }
        ...
        function createTaskElement(task) {
          ...
          circle.addEventListener('click', (event) =>
            (0, _editingTask__WEBPACK_IMPORTED_MODULE_1__.updateCompletedTask)(
              event,
              task,
            ),
          );
          ...
          importantStar.addEventListener('click', (event) =>
            (0, _editingTask__WEBPACK_IMPORTED_MODULE_1__.updateImportantTask)(
              event,
              task,
            ),
          );
          ...
          editContainer.addEventListener('click', () =>
            (0, _editingTask__WEBPACK_IMPORTED_MODULE_1__.showEditOptions)(
              taskDiv,
            ),
          );
          ...
          deleteTaskButton.addEventListener('click', () =>
            (0, _editingTask__WEBPACK_IMPORTED_MODULE_1__.deleteTask)(task.id),
          );
          ...
          editTaskButton.addEventListener('click', (event) =>
            (0, _editingTask__WEBPACK_IMPORTED_MODULE_1__.showEditForm)(event),
          );
        ...
        function findSelectedProject() {
          ...
          const index =
            _creatingProject__WEBPACK_IMPORTED_MODULE_0__.allProjects.findIndex(
  ...
  \****************************** */
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ closeRenameForm: () =>
            /* binding */ closeRenameForm,
          /* harmony export */ deleteProject: () => /* binding */ deleteProject,
          /* harmony export */ showEditOptions: () =>
            /* binding */ showEditOptions,
          /* harmony export */ showRenameForm: () =>
            /* binding */ showRenameForm,
          /* harmony export */
        });
        /* harmony import */ const _creatingProject__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        /* harmony import */ const _creatingTask__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./creatingTask */ './src/creatingTask.js');
        /* harmony import */ const _homeSection__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./homeSection */ './src/homeSection.js');
        ...
        function deleteProject(id) {
          ...
          _creatingProject__WEBPACK_IMPORTED_MODULE_0__.allProjects.splice(
            index,
            1,
          );
          (0,
        ...
        function showEditOptions(editContainer) {
          const optionsButtons =
            editContainer.querySelector('.options-buttons');
        ...
        function showRenameForm() {
          ...
          const projectTitle = selectedProject.querySelector(
            '.project-list-title',
          );
        ...
        function saveProjectTitle() {
          ...
          _creatingTask__WEBPACK_IMPORTED_MODULE_1__.findSelectedProject)();

          const newProjectTitle = document.getElementById(
            'rename-project-input',
          ).value;

          // Change project title in allProjects array and save it
          _creatingProject__WEBPACK_IMPORTED_MODULE_0__.allProjects[
            projectIndex
  ...
  \*************************** */
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ showEditOptions: () =>
            /* binding */ showEditOptions,
          /* harmony export */ updateCompletedTask: () =>
            /* binding */ updateCompletedTask,
          /* harmony export */ updateImportantTask: () =>
            /* binding */ updateImportantTask,
          /* harmony export */
        });
        /* harmony import */ const _creatingProject__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        function showEditForm(event) {
          ...
          cancelButton.addEventListener('click', () =>
            closeEditTaskForm(selectedTask),
          );
        ...
        function saveTask(task, selectedTaskDiv) {
          ...
          switch (selectedTile.id) {
            case 'all-tasks':
              (0, _homeSection__WEBPACK_IMPORTED_MODULE_2__.showAllTasks)();
              break;
            case 'today':
              (0, _homeSection__WEBPACK_IMPORTED_MODULE_2__.showTodayTasks)();
              break;
            case 'this-week':
              (0,
              _homeSection__WEBPACK_IMPORTED_MODULE_2__.showThisWeekTasks)();
              break;
            case 'important':
              (0,
              _homeSection__WEBPACK_IMPORTED_MODULE_2__.showImportantTasks)();
              break;
            default:
              break;
          }
  ...
  \*************************** */
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ showHomeSectionTile: () =>
            /* binding */ showHomeSectionTile,
          /* harmony export */ showImportantTasks: () =>
            /* binding */ showImportantTasks,
          /* harmony export */ showThisWeekTasks: () =>
            /* binding */ showThisWeekTasks,
          /* harmony export */ showTitle: () => /* binding */ showTitle,
          /* harmony export */ showTodayTasks: () =>
            /* binding */ showTodayTasks,
          /* harmony export */
        });
        /* harmony import */ const date_fns__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! date-fns */ './node_modules/date-fns/esm/format/index.js',
          );
        /* harmony import */ const date_fns__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! date-fns */ './node_modules/date-fns/esm/addDays/index.js',
          );
        /* harmony import */ const _creatingTask__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./creatingTask */ './src/creatingTask.js');
        /* harmony import */ const _creatingProject__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./creatingProject */ './src/creatingProject.js',
          );
        ...
        function showHomeSectionTile() {
          ...
          todayTasks.addEventListener('click', (event) =>
            showTodayTasks(event),
          );

          const thisWeekTasks = document.getElementById('this-week');
          thisWeekTasks.addEventListener('click', (event) =>
            showThisWeekTasks(event),
          );
        ...
        function showAllTasks(event) {
          ...
          if (
            _creatingProject__WEBPACK_IMPORTED_MODULE_1__.allProjects.length > 0
          ) {
            _creatingProject__WEBPACK_IMPORTED_MODULE_1__.allProjects.forEach(
              (project) => {
        ...
        function showTodayTasks(event) {
          ...
          const todayDate = (0, date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(
            rawDate,
            'yyyy-MM-dd',
          );
        ...
        function showThisWeekTasks(event) {
          ...
          for (let i = 0; i < 7; i++) {
            const nextDate = (0, date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(
              todayDate,
              i,
            );
            thisWeekDates.push(
  ...
  \********************* */
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ const _creatingProject__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./creatingProject */ './src/creatingProject.js');
    /* harmony import */ const _creatingTask__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./creatingTask */ './src/creatingTask.js');
    /* harmony import */ const _homeSection__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(/*! ./homeSection */ './src/homeSection.js');
