...
/* harmony export */   showImportantTasks: () => (/* binding */ showImportantTasks),
/* harmony export */   showThisWeekTasks: () => (/* binding */ showThisWeekTasks),
...
function showAllTasks(event) {
  ...
  if (_project__WEBPACK_IMPORTED_MODULE_1__.allProjects.length > 0) {
    _project__WEBPACK_IMPORTED_MODULE_1__.allProjects.forEach((project) => {
      project.tasks.forEach((task) => {
        allTasks.push(task);
      });
    });
  }
  (0,_task__WEBPACK_IMPORTED_MODULE_0__.showTasks)(allTasks);
}
...
function showTodayTasks(event) {
  ...
  const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(rawDate, 'yyyy-MM-dd');
  ...
  (0,_task__WEBPACK_IMPORTED_MODULE_0__.showTasks)(todayTasks);
}
...
function showThisWeekTasks(event) {
  ...
  for (let i = 0; i < 7; i++) {
    const nextDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todayDate, i);
    thisWeekDates.push((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(nextDate, 'yyyy-MM-dd'));
  }
  ...
  (0,_task__WEBPACK_IMPORTED_MODULE_0__.showTasks)(thisWeekTasks);
}
...
function showImportantTasks(event) {
  ...
  (0,_task__WEBPACK_IMPORTED_MODULE_0__.showTasks)(importantTasks);
}
...
function saveToLocalStorage() {
  ...
  localStorage.setItem('taskID', _task__WEBPACK_IMPORTED_MODULE_0__.taskID.toString());
}
...
function createProjectElement(project) {
  ...
  // Create three dots
  const editIcons = (0,_task__WEBPACK_IMPORTED_MODULE_0__.createEditIcons)();
...
function selectProject(event, project) {
  ...
  (0,_task__WEBPACK_IMPORTED_MODULE_0__.showTasks)(project.tasks);
...
function saveProjectTitle() {
  const projectIndex = (0,_task__WEBPACK_IMPORTED_MODULE_0__.findSelectedProject)();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createEditIcons: () => (/* binding */ createEditIcons),
...
function createNewTask() {
  ...
  const project = _project__WEBPACK_IMPORTED_MODULE_0__.allProjects[index].tasks;
...
function findSelectedProject() {
  ...
  const index = _project__WEBPACK_IMPORTED_MODULE_0__.allProjects.findIndex((project) => project.id === projectID);
  return index;
}
...
function findTaskById(selectedTaskID) {
  for (const project of _project__WEBPACK_IMPORTED_MODULE_0__.allProjects) {
...
function saveTask(task, selectedTaskElement) {
  ...
  switch (selectedTile.id) {
    case 'all-tasks':
      (0,_homeSection__WEBPACK_IMPORTED_MODULE_1__.showAllTasks)();
      break;
    case 'today':
      (0,_homeSection__WEBPACK_IMPORTED_MODULE_1__.showTodayTasks)();
      break;
    case 'this-week':
      (0,_homeSection__WEBPACK_IMPORTED_MODULE_1__.showThisWeekTasks)();
      break;
    case 'important':
      (0,_homeSection__WEBPACK_IMPORTED_MODULE_1__.showImportantTasks)();
      break;
    default:
      break;
  }
...
(0,_project__WEBPACK_IMPORTED_MODULE_0__.addEventListeners)();
(0,_task__WEBPACK_IMPORTED_MODULE_1__.createTaskEvents)();
